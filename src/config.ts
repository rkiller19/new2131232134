...
const configurations: {[env: string]: Configuration} = {
  ...
  development: {
    ...
    deployments: require('./bomb-finance/deployments/deployments.mainnet.json'),
    externalTokens: {
      WBNB: ['0x0000000000000000000000000000000000000000', 18],
      WAVAX: ['0x0000000000000000000000000000000000000000', 18],
      FUSDT: ['0x0000000000000000000000000000000000000000', 18], // This is actually BUSD on mainnet not fusdt
      BTCB: ['0x0000000000000000000000000000000000000000', 18],
      MIM: ['0x0000000000000000000000000000000000000000', 18],
      SBTC: ['0x0000000000000000000000000000000000000000', 18],
      SVL: ['0x0000000000000000000000000000000000000000', 18],
      SUSD: ['0x0000000000000000000000000000000000000000', 18],
      CAKE: ['0x0000000000000000000000000000000000000000', 18],
      ZOO: ['0x0000000000000000000000000000000000000000', 0],
      SHIBA: ['0x0000000000000000000000000000000000000000', 9],
      'USDT-BNB-LP': ['0x0000000000000000000000000000000000000000', 18], //mim avax
      'USDT-BTCB-LP': ['0x0000000000000000000000000000000000000000', 18],
      'CREAM-MIM-LP': ['0x0000000000000000000000000000000000000000', 18],
      'BOMB-BTCB-LP': ['0x0000000000000000000000000000000000000000', 18], //MIM-
      'BOMB-BNB-LP': ['0x0000000000000000000000000000000000000000', 18],
      'BSHARE-BNB-LP': ['0x0000000000000000000000000000000000000000', 18],
      'BSHARE-BNB-APELP': ['0x0000000000000000000000000000000000000000', 18],
      'BOMB-BTCB-APELP': ['0x0000000000000000000000000000000000000000', 18],
    },
...
export const bankDefinitions: {[contractName: string]: BankInfo} = {
  ...
  */
  ...
  CreamWavaxRewardPool1: {
    name: 'Earn CREAM with WAVAX',
    poolId: 1,
    sectionInUI: 1,
    contract: 'CreamWavaxRewardPool1',
    depositTokenName: 'WAVAX',
    earnTokenName: 'CREAM',
    finished: true,
    sort: 5,
